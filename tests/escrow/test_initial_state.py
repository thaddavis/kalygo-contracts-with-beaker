...
def test_initial_state(escrow_contract):
    ...
    assert app_info_formatted["global_escrow_payment_1"] == 100000
    assert app_info_formatted["global_escrow_payment_2"] == 100000
    assert app_info_formatted["global_total_price"] == 200000
