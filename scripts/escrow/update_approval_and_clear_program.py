...
def main():
    ...
    app_client.update(
        ...
        # glbl_escrow_payment_1=200000,
        # glbl_escrow_payment_2=200000,
        # glbl_total_price=400000,
        # glbl_buyer: abi.Address,
        # glbl_seller: abi.Address,
        # glbl_escrow_payment_1: abi.Uint64,
        # glbl_escrow_payment_2: abi.Uint64,
        # glbl_total_price: abi.Uint64,
        # glbl_inspection_start_date: abi.Uint64,
        # glbl_inspection_end_date: abi.Uint64,
        # glbl_inspection_extension_date: abi.Uint64,
